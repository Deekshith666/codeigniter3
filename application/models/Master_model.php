...
public function get_Tax($id="0")
	...
	,'gtl_added_on' => date('Y-m-d h:i:s')
				...
				public function get_Purchase($id="0")
				{
					...
					$this->db->join("gen_item_lookup",'gil_id_pk = ipd_Item_fk');
					$this->db->join("gen_manufacturer_lookup",'gml_id_pk = ipd_Manufacturer_fk');
					$this->db->join("gen_tax_group_lookup",'gtgl_id_pk = ipd_Tax_fk');
