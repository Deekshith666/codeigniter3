...
<nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                	<?php $submenu = $CI->Header_model->get_submenu($row['MT_ID_PK']);?>
                    <a href="<?php echo $row['MT_Name'];?>" <?php if(sizeof($submenu) > 0){echo 'aria-expanded="false"';}?>><i class="fa fa-diamond"></i> <span class="nav-label"><?php echo $row['MT_Name'];?></span>
					<?php if(sizeof($submenu) > 0){echo '<span class="fa arrow"></span>';}?>
                    </a>
                    <?php
					if(sizeof($submenu) > 0)
					{
                        ...
                        <li><a href="index.html"><?php echo $row1['MT_Name'];?></a></li>
                        <?php } ?>
                    	</ul>
                        <?php
					}
