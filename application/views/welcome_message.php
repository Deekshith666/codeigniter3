                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content no-padding">
                        <div class="flot-chart m-t-lg" style="height: 55px;">
                            <div class="flot-chart-content" id="flot-chart1" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 395.188px; height: 55px;" width="493" height="68"></canvas><canvas class="flot-overlay" width="493" height="68" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 395.188px; height: 55px;"></canvas></div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas id="lineChart" height="242" style="display: block; height: 194px; width: 511px;" width="638" class="chartjs-render-monitor"></canvas>
                                    </div>
                                </div>
                                <div class="col-md-4">
